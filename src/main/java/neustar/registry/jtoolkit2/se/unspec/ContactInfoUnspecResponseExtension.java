 ...
 *
 * <p>Use this to get information about a contact.
 * Such a service element is sent by a compliant EPP server in response
 * to a valid Contact Info command with the Neulevel Unspec extension.</p>
 *
 ...
 *
 * @see ContactInfoUnspecResponseExtension
 */
public final class ContactInfoUnspecResponseExtension extends ResponseExtension {
