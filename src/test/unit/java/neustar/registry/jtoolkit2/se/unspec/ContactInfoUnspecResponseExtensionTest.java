...
public class ContactInfoUnspecResponseExtensionTest {
    ...
    private final String RESPONSE_XML_NEULEVEL_UNSPEC =
            "<neulevel:unspec>nexuscategory=ORG EXTContact=EXTCONTACT-101</neulevel:unspec>\n";
    ...
    private ContactInfoUnspecResponseExtension response;
    private XMLParser parser;

    @Before
    public void setUp() throws Exception {
        response = new ContactInfoUnspecResponseExtension();
    ...
    public void shouldParseTheResponseAndPopulateTheUnspecDetails() throws ParsingException, XPathExpressionException {
        response.fromXML(parser.parse(RESPONSE_XML));
        assertEquals(response.getUnspecDetails(), "nexuscategory=ORG EXTContact=EXTCONTACT-101");
    }
