...
public class DomainInfoKV11ResponseExtensionTest {
    ...
    public void testNonExistentListName() throws Exception {
        ...
        final DomainInfoKV11ResponseExtension kvExtension = new DomainInfoKV11ResponseExtension();
        ...
        final String xml =
            "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone='no'?>"
                    ...
                    + "             <domain:name>example.com.ae</domain:name>"
                    ...
                    + "                 <domain:hostObj>ns2.example.com.ae</domain:hostObj>"
                    + "             </domain:ns>"
                    + "             <domain:host>ns1.example.com.ae</domain:host>"
                    + "             <domain:host>ns2.exmaple.com.ae</domain:host>"
                    ...
                    + "             <domain:authInfo><domain:pw>0192pqow</domain:pw></domain:authInfo>"
                    + "         </domain:infData>"
                    + "     </resData>"
                    + "     <extension>"
                    + "         <kv:infData xmlns:kv=\"urn:X-ar:params:xml:ns:kv-1.1\" "
                    + "                 xsi:schemaLocation=\"urn:X-ar:params:xml:ns:kv-1.1 kv-1.1.xsd\">"
                    + "             <kv:kvlist name=\"kvListTwo\">"
                    + "                 <kv:item key = \"registrantName\">RegistrantName Pty. Ltd.</kv:item>"
                    + "                 <kv:item key=\"registrantIDType\">Trade License</kv:item>"
                    + "                 <kv:item key=\"registrantIDValue\">123456789</kv:item>"
                    + "                 <kv:item key=\"eligibilityType\">Trademark</kv:item>"
                    + "                 <kv:item key=\"eligibilityName\">Registrant Eligi</kv:item>"
                    + "                 <kv:item key=\"eligibilityIDType\">Trademark</kv:item>"
                    + "                 <kv:item key=\"eligibilityIDValue\">987654321</kv:item>"
                    + "                 <kv:item key=\"policyReason\">2</kv:item>"
                    + "             </kv:kvlist>"
                    + "         </kv:infData>"
                    + "     </extension>"
                    + "     <trID><clTRID>ABC-12345</clTRID><svTRID>805</svTRID></trID>"
                    + " </response>"
                    + "</epp>";
    ...
    public void testNotInitialisedWhenNoKVExtensionPresent() throws Exception {
        ...
        final String xml =
            "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"no\"?>"
                    ...
                    + "           <domain:infData xmlns:domain=\"urn:ietf:params:xml:ns:domain-1.0\" "
                    + "                   xsi:schemaLocation=\"urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd\">"
                    + "               <domain:name>viewdomain.registrar.au</domain:name>"
                    + "               <domain:roid>D604E5509E82DF9F3105B7E182BB4DF28-AR</domain:roid>"
                    + "               <domain:status s=\"inactive\"/>"
                    + "               <domain:registrant>CON-1</domain:registrant>"
                    + "               <domain:contact type=\"tech\">CON-1</domain:contact>"
                    + "               <domain:clID>EPP</domain:clID>"
                    + "               <domain:crID>EPP</domain:crID>"
                    + "               <domain:crDate>2010-08-12T00:33:20.0Z</domain:crDate>"
                    + "               <domain:exDate>2012-08-12T00:33:21.0Z</domain:exDate>"
                    + "               <domain:authInfo><domain:pw>123paSSword</domain:pw></domain:authInfo>"
                    + "           </domain:infData>"
                    + "       </resData>"
                    + "       <trID>"
                    + "         <clTRID>TESTER1.20100812.003321.1</clTRID>"
                    + "         <svTRID>9223372036854778924</svTRID>"
                    + "       </trID>"
                    + "   </response>"
                    + "</epp>";
    ...
    private void checkKeyValueList(final DomainInfoKV11ResponseExtension kvExtension, String listName) {
