...
public class AuDomainInfoResponseV1Test {
    private static final String XML =
        "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone='no'?>"
                ...
                + "<domain:hostObj>ns2.example.com.au</domain:hostObj></domain:ns>"
                + "<domain:host>ns1.example.com.au</domain:host><domain:host>ns2.exmaple.com.au</domain:host>"
                ...
                + "<extension><auext:extensionAU xmlns:auext=\"urn:au:params:xml:ns:auext-1.0\" "
                + "xsi:schemaLocation=\"urn:au:params:xml:ns:auext-1.0 auext-1.0.xsd\">"
                + "<auext:info><auext:registrantName>RegistrantName Pty. Ltd.</auext:registrantName>"
                ...
                + "<auext:policyReason>2</auext:policyReason></auext:info></auext:extensionAU></extension>"
                + "<trID><clTRID>ABC-12345</clTRID><svTRID>805</svTRID></trID></response></epp>";

    private AuDomainInfoResponseV1 response;

    @Before
    public void setUp() throws Exception {
        response = new AuDomainInfoResponseV1();
